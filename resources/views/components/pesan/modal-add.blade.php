    ...
    <div class="relative bg-slate-800/95 text-gray-200 rounded-xl w-96 p-6 shadow-lg shadow-blue-400 z-50">
        ...
        <form id="formAddPesan" onsubmit="event.preventDefault(); createPesan()">
            <div class="mb-4">
                ...
                <input type="text" id="addPesanPengirim" name="pengirim" required
                ...
                <input type="text" id="addPesanPenerima" name="penerima" required
                    class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-200 p-2
                           focus:ring-2 focus:ring-blue-500 focus:outline-none hover:ring-2 hover:ring-blue-500 mb-3">

                <label for="addPesanIsi" class="block text-sm font-medium mb-1">Isi</label>
                <input type="text" id="addPesanIsi" name="isi" required
                    class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-200 p-2
                           focus:ring-2 focus:ring-blue-500 focus:outline-none hover:ring-2 hover:ring-blue-500 mb-3">

                <label for="addPesanParentID" class="block text-sm font-medium mb-1">Parent ID</label>
                ...
                <label for="addPesanTglPesan" class="block text-sm font-medium mb-1">Tgl Pesan</label>
                <input type="datetime-local" id="addPesanTglPesan" name="tgl_pesan"
                    class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-200 p-2 mb-3">

                <label for="addPesanJenisPesan" class="block text-sm font-medium mb-1">Jenis ID</label>
