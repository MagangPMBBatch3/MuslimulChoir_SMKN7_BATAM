...
<div id="modalAddJenisPesan" class="fixed inset-0 bg-white/50 items-center justify-center flex z-50 hidden">
    <div class="bg-white p-6 rounded-lg shadow-lg shadow-blue-400 w-96">
        ...
        <form id="formAddJenisPesan" onsubmit="createJenisPesan(event)">
            @csrf
            <div class="mb-4">
                <label for="addJenisPesanNama" class="block text-sm font-medium mb-1">Nama JenisPesan</label>
                <input type="text" id="addJenisPesanNama" name="namaJenisPesan"
