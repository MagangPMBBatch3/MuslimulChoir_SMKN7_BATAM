...
<div id="modalAddStatusJamKerja" class="fixed inset-0 bg-white/50 items-center justify-center flex z-50 hidden">
    <div class="bg-white p-6 rounded-lg shadow-lg shadow-blue-400 w-96">
        <h2 class="text-xl font-bold mb-4 text-center">Tambah Data StatusJamKerja</h2>
        
        <form id="formAddStatusJamKerja" onsubmit="createStatusJamKerja(event)">
            @csrf
            <div class="mb-4">
                <label for="addStatusJamKerjaNama" class="block text-sm font-medium mb-1">Nama StatusJamKerja</label>
                <input type="text" id="addStatusJamKerjaNama" name="namaStatusJamKerja"
