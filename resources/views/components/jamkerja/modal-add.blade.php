        ...
        <form id="formAddJamKerja" onsubmit="event.preventDefault(); createJamKerja()">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="no_wbs" name="no_wbs" readonly
                        class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-400 p-2 cursor-not-allowed">
                </div>

                <!-- Kode Proyek -->
                <div>
                    <label for="kode_proyek" class="block mb-1 text-sm">Kode Proyek</label>
                    <input type="text" id="kode_proyek" name="kode_proyek" readonly
                        class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-400 p-2 cursor-not-allowed">
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <textarea id="addJamKerjaKeterangan" name="keterangan"
                        ...
                        class="w-full rounded-md border border-slate-600 bg-slate-700/70 text-gray-200 p-2"></textarea>
                </div>
            </div>
