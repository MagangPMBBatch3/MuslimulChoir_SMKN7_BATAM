...
<div id="modalEditJamKerja" class="fixed inset-0 hidden items-center justify-center flex z-50">
    ...
    <div class="relative bg-slate-800/95 text-gray-200 rounded-xl w-[28rem] p-6 shadow-lg shadow-blue-400 z-50">
        <button onclick="closeEditJamKerjaModal()" class="text-gray-200 hover:text-red-400 text-xl font-bold absolute right-5">&times;</button>
        ...
        <form id="formEditJamKerja" onsubmit="event.preventDefault(); updateJamKerja()">
            ...
            <div class="grid grid-cols-2 gap-0.5">
                ...
                <!-- Proyek -->
                <div>
                    <label for="editJamKerjaProyekID" class="block mb-1 text-sm">Nama Proyek:</label>
                ...
                <!-- Aktivitas -->
                <div>
                    <label for="editJamKerjaAktivitasID" class="block mb-1 text-sm">Nama Aktivitas:</label>
                ...
                <!-- Status -->
                <div>
                    <label for="editJamKerjaStatusID" class="block mb-1 text-sm">Nama Status:</label>
                ...
                <!-- Mode Jam Kerja -->
                <div>
                    <label for="editJamKerjaModeJamKerjaID" class="block mb-1 text-sm">Nama ModeJamKerja:</label>
                ...
                <div class="col-span-2">
                    <label for="editJamKerjaKeterangan" class="block mb-1 text-sm">Nama Keterangan:</label>
            ...
            <div class="flex justify-end gap-2 mt-6 border-t border-slate-700 pt-4">
                <x-button type="button" variant="secondary" onclick="closeEditJamKerjaModal()"> Batal</x-button>
