<x-layouts.main title="Data Lembur">
    <div class="bg-slate-800/90 p-4 rounded-xl shadow w-full">
        <h1 class="text-2xl font-bold mb-4 text-white">Data Lembur</h1>
            ...
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                <thead class="bg-slate-700 text-gray-300 uppercase text-xs">
                    <tr>
                        ...
                        <th class="border border-slate-600 p-2">User Profile</th>
                ...
                <tbody id="dataLembur" class="divide-y divide-slate-700 text-gray-200"></tbody>
            </table>
        </div>
        ...
        <div id="tableArsip" class="hidden">
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                ...
                <tbody id="dataLemburArsip" class="divide-y divide-slate-700 text-gray-200"></tbody>
            </table>
        </div>
    </div>
