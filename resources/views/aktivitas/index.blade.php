    ...
    <div class="bg-slate-800/90 p-4 rounded-xl shadow w-full">
        ...
        <div id="tableAktif">
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                ...
                <tbody id="dataAktivitas" class="divide-y divide-slate-700 text-gray-200"></tbody>
            </table>
        </div>
        ...
        <div id="tableArsip" class="hidden">
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                ...
                <tbody id="dataAktivitasArsip" class="divide-y divide-slate-700 text-gray-200"></tbody>
            </table>
        </div>
    </div>
