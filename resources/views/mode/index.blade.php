<x-layouts.main title="Data Mode Jam Kerja">
     <x-slot name="pageTitle">Data Mode Jam Kerja</x-slot>
...
<h1 class="text-2xl font-bold mb-4 text-white flex items-center gap-2">
    <i class="bx bx-calendar-check text-blue-400"></i>
    Mode Jam Kerja
</h1>
        ...
        <div id="tableArsip" class="hidden">
            <x-table id="dataModeJamKerjaArsip">
                    <x-slot:head>
                        <x-th align="center">ID</x-th>
                        <x-th align="center">Nama</x-th>
                        <x-th align="center">Aksi</x-th>
