<x-layouts.main title="Data Jam Kerja">
    <div class="bg-white p-4 rounded shadow w-full">
        ...
        <div class="flex justify-between mb-4">
            <input type="text" id="search" placeholder="Cari ID atau Nama..." class="border p-2 rounded w-64" oninput="searchJamKerja()">
            ...
            <table class="w-full border">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="border p-2">Kode Proyek</th>
                        <th class="border p-2">Nama Proyek</th>
                        <th class="border p-2">Nama Aktivitas</th>
