    ...
    <div class="bg-slate-800/90 p-4 rounded-xl shadow w-full">
            ...
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                <thead class="bg-slate-700 text-gray-300 uppercase text-xs">
                    <tr>
                        ...
                        <th class="p-2 border border-slate-600">Kode</th>
                        <th class="p-2 border border-slate-600">Nama</th>
                        <th class="p-2 border border-slate-600">Tanggal</th>
                        <th class="p-2 border border-slate-600">Nama Sekolah</th>
                        <th class="p-2 border border-slate-600">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataProyek" class="divide-y divide-slate-700 text-gray-200 hover:[&>tr:hover]:bg-slate-700/50"></tbody>
            </table>
        </div>
        ...
        <div id="tableArsip" class="hidden">
            <table class="w-full border border-slate-700 rounded-lg overflow-hidden">
                ...
                <tbody id="dataProyekArsip" class="divide-y divide-slate-700 text-gray-200 hover:[&>tr:hover]:bg-slate-700/50"></tbody>
            </table>
        </div>
