<x-layouts.main title="Data User">
     <x-slot name="pageTitle">Data User</x-slot>
    ...
    <i class="bx bx-group text-cyan-400"></i>
    Data User
</h1>
        ...
        <div id="tableAktif">
            <x-table id="dataUser">
                    <x-slot:head>
                        ...
                        <x-th align="center">Email</x-th>
                        <x-th align="center">Role</x-th>
